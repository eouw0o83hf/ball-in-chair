...
{
    public class ListPositivePlayersAction : CliActionBase
    {
        public override string CommandName => "player balances";
        private const int ColumnPaddingSpaces = 4;

        private readonly IPlayerService _playerService;
        private readonly ILedgerService _ledgerService;

        public ListPositivePlayersAction(IPlayerService playerService, ILedgerService ledgerService)
        {
